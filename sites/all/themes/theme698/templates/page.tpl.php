...
<div id="page-wrapper">
  ...
  <div id="main-wrapper">
    ...
    <?php if ($page['sidebar_second']): ?>
        <aside id="sidebar-second" class="column sidebar <?php if ($page['content_before']): ?> indent <?php endif; ?>" role="complementary">
            <div class="section">
    ...
    <footer id="footer" role="contentinfo">
        <div class="footer-wrapper clearfix">
            ...
            <?php if ($is_front): ?>More <a rel="nofollow" href="http://www.templatemonster.com/category/game-portal-drupal-themes/" target="_blank">Game Portal Drupal Themes at TemplateMonster.com</a><?php endif; ?>
        </div><!-- /#footer-wrapper -->
    </footer><!-- /#footer -->
